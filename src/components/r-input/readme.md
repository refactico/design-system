...
| `color`              | `color`                | The input color (Ionic color)                                          | `"danger" \| "dark" \| "light" \| "medium" \| "primary" \| "secondary" \| "success" \| "tertiary" \| "warning"` | `undefined` |
...
| `fill`               | `fill`                 | The input fill style                                                   | `"clear" \| "default" \| "outline" \| "solid"`                                                                  | `undefined` |
